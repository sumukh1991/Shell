 ...
 * the next command on the list, and the control operator that separated the
...
struct job {
	...
	status_t status; // status of teh command

	int printstatus; // output print status
};
